...
class CQPWebScraper(object):
    def __init__(self, username, password, corpus, queries=[], n_gram=3):
        self.home_url = 'https://cs-cqpweb.swansea.ac.uk/'
...
if __name__ == '__main__':
    ...
    crawler = CQPWebScraper(username='matteo',
                            password='C05cqpweb@2017!',
                            corpus='https://cs-cqpweb.swansea.ac.uk/pj_norm_v2',
                            queries=queries)
    crawler.login()
    # parse the files
